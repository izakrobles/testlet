                    ...
                    <div class="form login">
                        <div class="form-content">
                            ...
                            <form id="login-form" action="#">
                                ...
                                <div class="field input-field">
                                    <input type="password" placeholder="Password" value={password} required class="password-field" onChange={(e) => setPassword(e.target.value)}/>
                                    <i class="bx bx-hide eye-icon" ref={pwShowHideRefLogin} onClick={() => handleShowHideClick(pwShowHideRefLogin)}/>
                                </div>
                                <div class="form-link">
                                ...
                                <div class="form-link">
                                    ...
                                    <a href="#" onClick={handleRegisterLink}>Register Here</a>
                                </div>
                            </form>
                        </div>
                    <div class="form-line"/>
                ...
                <div class="form signup">
                    <div class="form-content">
                        <header class="form-header">Signup</header>
                            ...
                            <div class="field input-field">
                                <input type="email" placeholder="Email" id="signup-email" class="input" required/>
                            </div>
                            <div class="field input-field">
                                <input type="password" placeholder="Password" id="signup-pwd" class="password-field" required/>
                                <i class="bx bx-hide eye-icon" ref={pwShowHideRefSignup} onClick={() => handleShowHideClick(pwShowHideRefSignup)}/>
                            </div>
                            <div class="field input-field">
                                <input type="password" placeholder="Password" id="confirm-pwd" class="password-field" required/>
                            </div>
                            ...
                            <div class="form-link">
                                ...
                                <a href="#" onClick={handleRegisterLink}>Login Here</a>
                            </div>
                            </form>
                        </div>
                    <div class="form-line"/>
